...
verify-staking-mainnet:
	...
	source .env && forge verify-contract --chain 19880818  --compiler-version v0.8.26 --verifier blockscout --verifier-url $MAIN_NET_VERIFIER_URL 0x9A8A1051265da7D53D94177a69E4E7244900BDc3 src/NFTStaking.sol:NFTStaking
