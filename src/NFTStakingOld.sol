...
contract NFTStakingOld is Initializable, OwnableUpgradeable, UUPSUpgradeable, ReentrancyGuardUpgradeable {
    IStateContract stateContract;
...
//
    ...
    function getTopStakeHolders() public view returns (address[3] memory top3HoldersAddress,uint256[3] memory top3HoldersCalcPoint) {
