...
//
//        dbcAIContractAddr = address(new DBCStakingContractMock());
//        staking.setDBCAIContract(dbcAIContractAddr);
...
//        staking.stake(machineId, 0, tokenIds, 2 hours / staking.SECONDS_PER_BLOCK(), 0);
//        vm.stopPrank();
//
...
//
//        staking.stake(machineId2, 0, tokenIds0, 2 hours / staking.SECONDS_PER_BLOCK(), 0);
//        passDays(1);
//
...
//        );
//
//        (, uint256 rewardAmountCanClaim, uint256 lockedRewardAmount,) = staking.getRewardInfo(machineId2);
...
//
//        (, uint256 rewardAmountCanClaim0, uint256 lockedRewardAmount0,) = staking.getRewardInfo(machineId2);
...
//
//        (, uint256 rewardAmountCanClaim1, uint256 lockedRewardAmount1,) = staking.getRewardInfo(machineId2);
...
//        staking.stake(machineId3, 10 * 1e18, tokenIds3, 2 hours / staking.SECONDS_PER_BLOCK(), 0);
...
//
//        assertEq(topHolders1[0].holder, stakeHolder2, "topHolders1[0].holder, stakeHolder2");
//        assertEq(topHolders1[0].totalCalcPoint, 300, "top 1 holder calc point 300 failed");
//
//        assertEq(topHolders1[1].holder, stakeHolder, "topHolders1[1].holder, stakeHolder1");
//        assertEq(topHolders1[1].totalCalcPoint, 200, "top 2 holder calc point 200 failed");
//
...
//            abi.encode(address(0x20), 100, 3600, "", 0, "", "")
//        );
//        staking.stake(machineId, 0, tokenIds, 2 hours / staking.SECONDS_PER_BLOCK(), 0);
//        vm.stopPrank();
//        (NFTStakingState.StakeHolder[] memory topHolders1, uint256 total) = state.getTopStakeHolders(0, 10);
...
//            dbcAIContractAddr,
//            abi.encodeWithSelector(IDBCAIContract.getMachineInfo.selector),
//            abi.encode(address(0x10), 100, 3600, "", 0, "", "")
//        );
//
//        staking.stake(machineId2, 100000 * 1e18, tokenIds1, 2 hours / staking.SECONDS_PER_BLOCK(), 0);
//        vm.stopPrank();
//        passDays(1);
//
//        vm.startPrank(stakeHolder2);
...
//        staking.stake(machineId3, 1000000 * 1e18, tokenIds2, 2 hours / staking.SECONDS_PER_BLOCK(), 0);
...
//        staking.stake(machineId4, 10000000 * 1e18, tokenIds3, 2 hours / staking.SECONDS_PER_BLOCK(), 0);
//        vm.stopPrank();
//        passDays(1);
//
//        vm.startPrank(stakeHolder2);
...
//
//        vm.startPrank(stakeHolder2);
//        staking.stake(machineId2, 0, tokenIds0, 0, 0);
//        passHours(1);
//
//        uint256 reward2 = staking.getReward(machineId2);
//        assertGt(reward2, 0, "machineId2 get reward lt 0  failed after staked 1 day");
...
//            abi.encodeWithSelector(IPrecompileContract.getDLCRentFeeByCalcPoint.selector),
//            abi.encode(100)
//        );
...
//
//        (uint256 phaseOneBurnAmount,,,, uint256 totalBurnAmount) = rent.totalBurnedAmount();
//
//        assertEq(phaseOneBurnAmount, fee, "phase one burned amount failed");
//        assertEq(totalBurnAmount, fee, "total burned amount failed");
//
//        uint256 amount = rent.stakeHolder2RentFee(Rent.StakingType.phaseOne, stakeHolder2);
//
...
//        tokenIds[0] = 1;
//        vm.startPrank(stakeHolder);
//        staking.stake(machineId, 0, tokenIds, 0, 0);
//
//        (NFTStakingState.StakeHolder[] memory topHolders,) = state.getTopStakeHolders(0, 10);
//        assertEq(topHolders[0].holder, stakeHolder, "topHolders[0].holder, stakeHolder");
//        assertEq(topHolders[0].totalCalcPoint, 100, "top1 holder calc point 100 failed");
